...
EVENT_SCENE_INSTRUCTION = (
    ...
    "この場所・この人物自身を軸にし、他の場所や他の人物の筋で使っている"
    "語彙・構図(「情報ノイズ」「記憶の残滓」「境界が揺らぐ」のような、"
    "場所を問わず使い回せる抽象的な言い回し)をそのまま輸入しない。"
    "その場所固有の環境・産業・人間関係から出来事を立てる。"
    "文体は説明文にせず、改行を惜しまず1〜4行程度の段落で区切る。"
    "「情報が」「システムが」のようなキャラクター不在の主語で状況を語るの"
    "ではなく、そのときキャラクターが何を感じ、何を見て、何を思うかを中心"
    "に書く。"
)
