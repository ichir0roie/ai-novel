...
EVENT_RECORD_INSTRUCTION = (
    ...
    "書くのは、この出来事で新しく起きた事象だけ。誰が、誰(どの対象)に対して、"
    ...
    "少なくとも一つを名指しで使い、行動は人物・対象それぞれを主語に立てて"
...
EVENT_PROGRESSION_INSTRUCTION = (
    ...
    "人物・対象ごとに渡す recent_events(その者自身が場所を問わず関わった直近の"
...
EVENT_DURATION_INSTRUCTION = (
    ...
    "対象は、この日数のあいだ進行中として次の出来事の対象から外れる。"
...
CHARACTER_TEXT_UPDATE_INSTRUCTION = (
    ...
    "(パーソナリティ。人物以外の対象なら性質・方針・立場)についてだけ"
