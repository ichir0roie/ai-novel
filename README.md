...
- 出来事・行動・居場所は `{年}_{月}_{日}_{名}.md`。時刻まで要るなら
  `{年}_{月}_{日}_{hhmmss}_{名}.md`（`4360_7_12_着陸.md` / `4360_7_12_093000_着陸.md`）。
  front matter の中は `y/m/d hh:mm:ss`。**年に上限はない**（`tools/stamp.py`）
